...
import { highlightCode } from "@/lib/pure-ui/mdx/code-highlighter";
  ...
  return (
    <pre
      className={cn(
        ...
        "[data-shiki] pre, [data-shiki] code, .shiki pre, .shiki code { font-family: var(--font-noto-mono) !important; }",
        className
      )}
      {...props}
    >
