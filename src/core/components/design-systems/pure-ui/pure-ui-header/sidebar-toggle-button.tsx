...
export const PureUISidebarToggleButton = () => {
  ...
  return (
    <button
      ...
      onClick={toggle}
      data-open={isOpen}
      className="group cursor-pointer p-[5px] hover:bg-surface-2 rounded-md mr-2"
    >
      <div className="relative">
        ...
        >
          <path
            ...
            fill="var(--color-surface-11)"
          ></path>
        </svg>
        <div
          className="w-[1.5px] h-[10px] bg-bg absolute top-1/2 -translate-y-1/2 left-[3px] rounded-[1px] [transition:width_0.3s_cubic-bezier(.25,.46,.45,.94)] bg-surface-4"
